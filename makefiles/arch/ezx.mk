...
CFLAGS = -pipe -DQWS -fno-exceptions -fno-rtti -Wall -W -mcpu=iwmmxt -mtune=iwmmxt -DEZX -DQT_NO_DEBUG -DQT_NO_DRAGANDDROP -DQT_NO_PROPERTIES -DQT_NO_TOOLBUTTON -Wno-ctor-dtor-privacy -fexpensive-optimizations -fomit-frame-pointer -DINSTALLDIR=\"$(INSTALLDIR)\" -DBETTER_TOOLBAR # -v -Q 
