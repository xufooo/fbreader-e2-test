...
#include "../dialogs/FullScreenDialog.h"
...
class QAboutDialog : public FullScreenDialog {
	Q_OBJECT

public:
	QAboutDialog(const char *caption); 
	~QAboutDialog();
...
class QApplicationWindow : public ZKbMainWidget, public ZLApplicationWindow {
	Q_OBJECT
