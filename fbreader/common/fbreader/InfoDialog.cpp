...
InfoDialog::InfoDialog(const std::string &fileName) : myBookInfo(fileName) {
	...
	infoTab.addOption(new ZLSimpleStringOptionEntry("Author", myBookInfo.AuthorDisplayNameOption));
	infoTab.addOption(new ZLSimpleStringOptionEntry("Sort", myBookInfo.AuthorSortKeyOption));
